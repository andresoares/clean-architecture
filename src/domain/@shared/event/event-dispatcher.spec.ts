...
import WhenCustomerAddressChangedHandler from "../../customer/event/handler/when-customer-address-changed.handler";
import WhenCustomerIsCreated1Handler from "../../customer/event/handler/when-customer-is-created-1.handler";
import WhenCustomerIsCreated2Handler from "../../customer/event/handler/when-customer-is-created-2.handler";
