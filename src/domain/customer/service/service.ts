...
import WhenCustomerAddressChangedHandler from "../event/handler/when-customer-address-changed.handler";
import WhenCustomerIsCreated1Handler from "../event/handler/when-customer-is-created-1.handler";
import WhenCustomerIsCreated2Handler from "../event/handler/when-customer-is-created-2.handler";
